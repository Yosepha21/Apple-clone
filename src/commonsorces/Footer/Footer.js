...
import usaflag from '../../project/images/icons/16.png'
...
function Footer()  {
  ...
  // let uuu=['Mac',"iPad", "iPhone", 'Watch', 'TV', 'Music', 'AirPods', 'HomePod', 'iPod', 'touch', 'Accessories', 'Gift', 'Cards']
    ...
    <div className="container">
      ...
      <div className="footer-links-wrapper row">
        ...
        <div className="links-wrapper-2 col-sm-12 col-md">
          ...
          <FooterLink links={['Apple Music',"Apple News+", "Apple TV+", 'Apple Arcade', 'Apple Card', 'iCloud']}
           /> 
          ...
          <FooterLink links={['Manage Your Apple ID',"Apple Store Account", "iCloud.com"]}
           /> 
        ...
        <div className="links-wrapper-3 col-sm-12 col-md">
          ...
          <FooterLink links={['Find a Store',"Genius Bar", "Today at Apple", 'Apple Camp', 'Field Trip', 'Apple Store Appc', 'Refurbished and Clearance', 'Financing', 'Apple Trade In', 'Order Status', 'Shopping Help']}
           /> 
{/* 
        ...
        <div className="links-wrapper-4 col-sm-12 col-md">
          <h3>For Business</h3>
          <ul>
          <FooterLink links={['Apple and Business',"Shop for Business"]}
           /> 
          ...
          <h3>For Education</h3>
          <ul>
          <FooterLink links={['Apple and Education',"Shop for College"]}
           /> 
        ...
        <div className="links-wrapper-5 col-sm-12 col-md">
          ...
          <FooterLink links={['Find a Store',"Genius Bar", "Today at Apple", 'Apple Camp', 'Field Trip', 'Apple Store App']}
           /> 
            {/* <li><a href="#">Find a Store</a></li>
            <li><a href="#">Genius Bar</a></li>
            <li><a href="#">Today at Apple</a></li>
      ...
      <div className="copyright-wrapper row">
        ...
        <div className="
              ...
              order-lg-3
            ">
          <div className="flag-wrapper"><img src={usaflag}/></div>
