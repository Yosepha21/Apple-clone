...
import usflag from '..//images/icons/16.png';
// import './Toggle';
    ...
    <div className="container">
      <div className="upper-text-container">
        <p>
          ...
          terms are in the
          <Link to="https://www.goldmansachs.com/terms-and-conditions/Apple-Card-Customer-Agreement.pdf" target="_blank">
      ...
      <div className="copyright-wrapper row">
        ...
        <div className="footer-country col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
          <div className="flag-wrapper"><img src={usflag}  alt="#"/></div>
